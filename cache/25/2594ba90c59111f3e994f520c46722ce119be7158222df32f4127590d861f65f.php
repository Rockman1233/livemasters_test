...
<div class=\"container\">
    ";
        ...
        if ((($context["title"] ?? null) == "CRUD интерфейс управления проектами")) {
            // line 41
            echo "    ";
            $this->loadTemplate("projects.php", "index.php", 41)->display($context);
            // line 42
            echo "    ";
        }
        // line 43
        ...
        if ((($context["title"] ?? null) == "Управление моделями")) {
            // line 44
            echo "    ";
            $this->loadTemplate("models.php", "index.php", 44)->display($context);
            // line 45
            echo "    ";
        }
        // line 46
...
<script>
    ...
    {
        return array (  90 => 46,  87 => 45,  84 => 44,  81 => 43,  78 => 42,  75 => 41,  73 => 40,  60 => 32,  54 => 31,  32 => 12,  19 => 1,);
    }
